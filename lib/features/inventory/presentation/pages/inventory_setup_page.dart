...
class InventorySetupPage extends StatelessWidget {
  const InventorySetupPage({
    super.key,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Aplica las migraciones de supabase/migrations para habilitar activos, existencias por sucursal, materias primas y recetas de productos.',
                ...
                const Text(
                  'También puedes probar la gestión del inventario con datos temporales sin conectarte a Supabase.',
                  style: TextStyle(color: Colors.black54, height: 1.5),
                ),
                const SizedBox(height: 16),
                OutlinedButton.icon(
